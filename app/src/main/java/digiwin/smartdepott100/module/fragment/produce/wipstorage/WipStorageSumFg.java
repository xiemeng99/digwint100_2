...
public class WipStorageSumFg  extends BaseFragment {
    ...
    private void getDetail(final ListSumBean listSumBean) {
        showLoadingDialog();
        listSumBean.setAvailable_in_qty(listSumBean.getApply_qty());
        wipCompleteLogic.getDetail(listSumBean, new CommonLogic.GetDetailListener() {
            @Override
            public void onSuccess(List<DetailShowBean> detailShowBeen) {
                Bundle bundle = new Bundle();
                bundle.putString(AddressContants.MODULEID_INTENT, pactivity.mTimestamp.toString());
                bundle.putString(CommonDetailActivity.MODULECODE, pactivity.module);
                bundle.putSerializable(CommonDetailActivity.ONESUM, listSumBean);
