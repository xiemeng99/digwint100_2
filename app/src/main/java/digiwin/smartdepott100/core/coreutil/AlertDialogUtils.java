...
public class AlertDialogUtils {
    ...
    private static ThreeBallRotationProgressBar viewById;
...
>>>>>>> 4d7b59101c1458e1b480d12370a5d31f39dc490b:app/src/main/java/digiwin/smartdepott100/core/coreutil/AlertDialogUtils.java
    ...
    public static void showRocketLoadingDialog(Context context) {
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "showRocketLoadingDialog-----Error");
        }
    }
    ...
    public static void showLoadingDialog(Context context) {
        try {
            if (context != null) {
                ...
                dialog = builder.view(R.layout.dialog_wait_boll)
                        .style(R.style.LoadingDialog)
                        .cancelTouchout(false)
                        .widthpx((int) (ViewUtils.getScreenWidth(context)))
                        .heightpx(ViewGroup.LayoutParams.MATCH_PARENT)
                        .backCancelTouchout(false)
                        .build();
                viewById = (ThreeBallRotationProgressBar) builder.getView(R.id.three_boll);
                viewById.setDistance(100).setMaxRadius(30).setMinRadius(15).setDuration(3000);
                viewById.startAnimator();
                dialog.show();
            }
        } catch (Exception e) {
            e.printStackTrace();
